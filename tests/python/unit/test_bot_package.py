...
SURFACE = {
    ...
    "commands/character.py": {
        ...
        "roots": ('begin', 'sheet', 'me', 'quests', 'inventory', 'inheritances', 'effects', 'reputation', 'grudges', 'daoheart', 'provenance', 'era', 'specialeffects', 'lifespan', 'karma', 'soul', 'afterlife', 'reincarnate', 'reset'),
        "leaves": {
    ...
    "commands/economy.py": {
        "groups": ('storage_group', 'auction_group', 'merchant_group', 'shop_group', 'stall_group', 'trade_group', 'civilization_group', 'market_group', 'blackmarket_group'),
        "roots": ('wallet', 'use'),
        "leaves": {
            ...
            "stall_group": ('board', 'status', 'open', 'list', 'withdraw', 'buy', 'close'),
    ...
    "commands/family.py": {
        ...
        "roots": (),
        "leaves": {
            "family_group": ('view', 'enter', 'leave', 'clan', 'support', 'contribute', 'tutor', 'errand', 'lesson', 'history', 'ancestry', 'investigate', 'legacy', 'quest', 'claim', 'conflict', 'child', 'descendants'),
