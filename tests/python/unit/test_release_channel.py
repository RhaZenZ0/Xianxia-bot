...
class BotWorkerTests(unittest.TestCase):
    ...
    def test_the_worker_is_started_only_when_enabled_and_cancelled_on_close(self):
        ...
        self.assertIn('for task_name in ("event_expiry_task", "operational_health_task", "update_check_task", "quest_forge_task", "route_audit_task", "weekend_gift_task", "topgg_metrics_task"):', BOT)
