...
async function loadAdmin(){
 ...
 <div class="admin-grid">
  ...
  <section class="card control"><h3>📈 Realm / Phase Override</h3><p>Directly set a player's cultivation realm and phase (story correction), bypassing normal breakthrough gating. The body ladder is optional: leave both fields blank to leave it unchanged, or fill both to set it in the same audited write.</p><label>Player<select id="realmPlayer">${pOpts}</select></label><div class="fieldrow"><label>Realm index (0-31)<input id="realmIndex" type="number" min="0" max="31" value="0"></label><label>Phase (1-9)<input id="realmPhase" type="number" min="1" max="9" value="1"></label></div><div class="fieldrow"><label>Body realm index (0-31)<input id="realmBodyIndex" type="number" min="0" max="31" placeholder="unchanged"></label><label>Body phase (1-9)<input id="realmBodyPhase" type="number" min="1" max="9" placeholder="unchanged"></label></div><label>Reason<input id="realmReason" value="GM story correction"></label><button class="btn primary" id="setRealm">Set realm</button></section>
