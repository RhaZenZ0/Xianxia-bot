# Changelog, v0.18 to v0.40.0, in full

The per-release entries as they were written, moved here at v1.0.0-rc.1 when `VERSIONS.md` was
trimmed to one paragraph per minor. Nothing here describes the current release.
