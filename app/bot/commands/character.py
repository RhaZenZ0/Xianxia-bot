    ...
    if c["phase"] == 9:
        if perfection and perfection["completed"]:
            ...
            perfect_text = (
                ...
                f"Quests {perfection['completed_quests']}/{WORLD.perfection_quest_count()} • use **/ascend → Realm Perfection → Info**"
            )
        else:
            perfect_text = "Stage 9 choice unlocked: **/ascend → Realm Perfection → Start** or **/ascend → Main Progression → Breakthrough** to skip perfection."
    ...
    if c.get("body_phase", 1) == 9:
        if body_perfection and body_perfection["completed"]:
            ...
            body_perfect_text = (
                ...
                f"Quests {body_perfection['completed_quests']}/{WORLD.body_perfection_quest_count()} • use **/ascend → Body Perfection → Info**"
            )
        else:
            body_perfect_text = "Body Stage 9 choice unlocked: **/ascend → Body Perfection → Start** or **/cultivation → Body → Breakthrough**."
