...
from .commands.boss import boss_group, hunter_group
from .commands.duel import duel_group
from .commands.equipment import (
    equipment_bind,
    equipment_bind_hub_options,
    equipment_equip,
    equipment_equip_hub_options,
    equipment_group,
    equipment_repair,
    equipment_repair_hub_options,
    equipment_status,
    equipment_unequip,
    equipment_unequip_hub_options,
)
from .commands.formation import formation_group
