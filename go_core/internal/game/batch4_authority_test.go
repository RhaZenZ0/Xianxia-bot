...
CREATE TABLE character_qi_body(user_id INTEGER PRIMARY KEY,purity INTEGER NOT NULL DEFAULT 50,meridians_open INTEGER NOT NULL DEFAULT 12,meridians_damaged INTEGER NOT NULL DEFAULT 0,dantian_state TEXT NOT NULL DEFAULT 'intact',settled_game_minute INTEGER NOT NULL DEFAULT 0,created_at REAL NOT NULL DEFAULT 0,updated_at REAL NOT NULL DEFAULT 0);
