...
**1.7.1** lets a market stall sell a trade's goods only for somebody who holds that trade's certificate, so a pill, a blade, a talisman or an array disk goes on a stall once its seller has passed an examination of the trade in this life.
